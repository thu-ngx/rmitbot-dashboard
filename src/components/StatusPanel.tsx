      ...
      <Card className="p-3 bg-slate-900/50 border-slate-700">
        <div className="flex flex-col items-center justify-center gap-2 text-center">
          <div className="flex items-center gap-1.5">
            <Battery
              className={`w-4 h-4 ${
                isConnected ? getBatteryColor() : "text-slate-600"
              }`}
            />
            <span className="text-xs text-slate-400">Battery</span>
          </div>
          <span
            className={`${isConnected ? getBatteryColor() : "text-slate-600"}`}
          >
      ...
      <Card className="p-3 bg-slate-900/50 border-slate-700">
        <div className="flex flex-col items-center justify-center gap-2 text-center">
          <div className="flex items-center gap-1.5">
            <Signal
              className={`w-4 h-4 ${
                isConnected ? "text-cyan-500" : "text-slate-600"
              }`}
            />
            <span className="text-xs text-slate-400">Signal</span>
          </div>
          <span className={isConnected ? "text-cyan-400" : "text-slate-600"}>
